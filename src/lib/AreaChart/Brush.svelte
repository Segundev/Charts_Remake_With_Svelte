...
<div class="slider clickable">
	<div use:pannable on:panmove={handlePanLeft} class="handle startMarker" style="left: 0%;">
		<div class="icon" style="background-color: red"></div>
	</div>
	<div class="interval" style="left: 0%; right: 0%;"></div>
	<div use:pannable on:panmove={handlePanRight} class="handle endMarker" style="left: 100%;">
		<div class="icon"></div>
	</div>
</div>
